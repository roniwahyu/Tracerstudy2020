...
class Mailer extends MX_Controller {
    ...
    // protected $_ci;
    protected $email_pengirim = 'noreply@widyagama.ac.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Roniwahyu'; // Isikan dengan nama pengirim
    protected $password = 'wjktaxjequlukblj'; // Isikan dengan password email pengirim
    ...
    {
    	$data=['subjek'=>"test mail",'content'=>"test mail localhost",'email_penerima'=>'roniwahyu@gmail.com'];
    	print_r($this->send($data));
    }
    public function send($data){
        ...
        if($send){ // Jika Email berhasil dikirim
            ...
            $response = array('status'=>'Gagal', 'message'=>'Email gagal dikirim','response'=>$send);
        }
