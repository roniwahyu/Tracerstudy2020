        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php
                    ...
                    if (!$listprodi) {
                        echo "<tr>
                                    <td colspan=\"4\">".$pesan.($ses_id_sp==0?' - Kode PT tidak ditemukan, silahkan masukkan Kode PT Anda melalui halaman <a href="'.base_url().'ws/welcome/setting">Setting</a>':'')."</td>
                              </tr>";
                    } else {
                        $i=0+$offset;
                        foreach ($listprodi as $key => $value) {
                            ...
                            echo "<tr>
                                        ...
                                        <!--td>";
                                            echo "<a href=\"javascript:void();\" class=\"modalButton\" data-toggle=\"modal\" data-src=\"".base_url()."ws/welcome/listdir/".$value['table']."\" data-target=\"#modalku\">
                                                      <span class=\"glyphicon glyphicon-tasks\" aria-hidden=\"true\"></span> Struktur 
                                                  </a> |  
                                                  <a href=\"javascript:void();\" class=\"modalButton\" data-toggle=\"modal\" data-src=\"".base_url()."ws/welcome/view/".$value['table']."\" data-height=\"300\" data-width=\"560\" data-target=\"#modalku\">
