...
class Ws_akm extends Admin_Controller {
    ...
    public function __construct()
    {
        ...
        if (!$this->session->userdata('login')) {
            ...
            $this->load->helper(['directory','csv','page_template']);
    ...
    public function akm($offset=0,$id_smt='')
    {
        ...
        $this->template->render('ws/tpl/akm/__akm_view',$data);
    }
    ...
    public function kelas($offset=0)
    {
        ...
        $this->template->render('ws/tpl/nilai/__view_kelas',$data);
    }
