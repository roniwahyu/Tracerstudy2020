...
class Welcome extends Admin_Controller {
	...
	public function __construct()
    {
        ...
        if (!$this->session->userdata('login')) {
            ...
            $this->load->helper(['page_template','csv']);
        }
    }
    ...
    public function listtable()
    {
        ...
        // tampil('ws/welcome/__listtabel',$data);
        $this->template->render('ws/tpl/welcome/__listtabel',$data);
    ...
    public function listprodi($offset=0)
    {
        ...
        //var_dump($temp_count);
        //pagination
        $config['base_url'] = site_url('ws/welcome/listprodi');
        ...
        $this->template->add_js(assets_url('js/ws.js'),'cdn');
        $this->template->render('ws/tpl/welcome/__listprodi',$data);
    }
    ...
    public function listdir($table='')
    {
        ...
        $data['tabel'] = $tables;
        $this->template->render('ws/tpl/__listdic',$data);
    }
    ...
    public function setting()
    {
        ...
        if ($this->input->post()) {
            ...
            if($this->form_validation->run() == TRUE) {
                ...
                if ($temp_result) {
                    ...
                    redirect(base_url().'ws/welcome/setting');
                } else {
        ...
        $data['npsn'] = $temp_npsn;
        $this->template->render('tpl/welcome/__setting',$data);
    }
}
