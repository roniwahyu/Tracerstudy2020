...
class Mailer {
    protected $_ci;
    protected $email_pengirim = SYSMAIL_USER; // Isikan dengan email pengirim
    protected $password = SYSMAIL_PASS; // Isikan dengan password email pengirim
    protected $nama_pengirim = SYSMAIL_NAME; // Isikan dengan nama pengirim
