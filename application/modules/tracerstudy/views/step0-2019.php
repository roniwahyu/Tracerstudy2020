            ...
            <tbody>
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <label class="kt-radio kt-radio--single kt-radio--success">
                                                            <input id="f301" type="radio" name="f301" value="1" onclick="show3()">
                                                            
                                                        <span></span>
                                                    </label>
                                                    </span>
                                                    <div class="input-group-text "><span class="hl">f301</span>&nbsp; <span class="text-primary">[1] Kira-kira</span></div>
                                                </div>
                                                 ...
                                                 <select name="f302" id="f302" class="form-control" required="required">
                                                                ...
                                                                <option value="13">Lebih dari 1 tahun</option>
                                                                
                                                            </select>
                                                 <div class="input-group-append">
                                                 
                                                    <span class="input-group-text text-dark">Bulan sebelum lulus ujian &nbsp;&nbsp; <span class="hl">(f3-01, f3-02)</span><br></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <label class="kt-radio kt-radio--single kt-radio--success">
                                                            <input id="f302" type="radio" name="f301" value="2" onclick="show3()">
                                                            
                                                        <span></span>
                                                    </label>
                                                    </span>
                                                    <div class="input-group-text "><span class="hl">f301</span>&nbsp; <span class="text-primary">[2] Kira-kira</span></div>
                                                </div>
                                                 ...
                                                 <div class="input-group-append">
                                                    ...
                                                    <span class="input-group-text text-dark">Bulan setelah lulus ujian &nbsp;&nbsp; <span class="hl">(f3-01, f3-03)</span><br></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <label class="kt-radio kt-radio--single kt-radio--warning">
                                                            <input id="f303" type="radio" name="f301" value="3" onclick="hide3()">
                                                            
                                                        <span></span>
                                                    </label>
                                                    </span>
                                                    <div class="input-group-text "><span class="hl">f301</span>&nbsp; <span class="text-primary">[3] Saya tidak mencari kerja</span></div>
                                                </div>
                                                 <div class="input-group-append">
                                                 
                                                    <span class="input-group-text text-dark"><i>(Langsung ke pertanyaan f8)</i> &nbsp;&nbsp; <span class="hl">(f3-01, f3-03)</span><br></span>
                                                </div>
                            ...
                            <div class="form-group col-md-8 col-sm-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <span class="input-group-text text-primary">[1] Kira-kira</span>
                                    </div>
                                     
                                     <select name="f502" id="f502" class="form-control" required="required">
                                                    <option value="0">Pilih x Bulan</option>
                                                    <option value="1">1 Bulan</option>
                                                    <option value="2">2 Bulan</option>
                                                    <option value="3">3 Bulan</option>
                                     ...
                                     <div class="input-group-append">
                                        ...
                                        <span class="input-group-text text-dark">Bulan sebelum lulus ujian &nbsp;&nbsp; <span class="hl">(f5-01, f5-02)</span><br></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group  col-md-8 col-sm-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <span class="input-group-text text-primary">[2] Kira-kira</span>
                                    </div>
                                    <select name="f503" id="f503" class="form-control" required="required">
                                                    <option value="0">Pilih x Bulan</option>
                                                    <option value="1">1 Bulan</option>
                                                    <option value="2">2 Bulan</option>
                                                    <option value="3">3 Bulan</option>
                                     ...
                                     <div class="input-group-append">
                                        ...
                                        <span class="input-group-text text-dark">Bulan setelah lulus ujian &nbsp;&nbsp; <span class="hl">(f5-01, f5-02)</span><br></span>
                                    </div>
                                </div>
                            </div>
                ...
                <tr id="f6">
                    ...
                    <input type="text" class="form-control" name="f6" size="5" value=""> perusahaan/instansi/institusi
                     <span class="errmsgf6 f6 text-info">(Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)</span>
                    </td>
                </tr>
                <tr>
                   <td colspan="2"></td> 
                ...
                <tr id="f7">
                    ...
                    <td valign="top" colspan="3"><h5>Berapa banyak perusahaan/instansi/institusi yang merespons lamaran anda?</h5>
                     ...
                     <span class="errmsgf7 f7 text-info">(Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)</span>
                    </td>
                </tr>
                <tr id="f7a">
                    <td class="h">f7a</td>
                    <td valign="top" colspan="3"><h5>Berapa banyak perusahaan/instansi/institusi yang mengundang anda untuk wawancara?</h5>
                     ...
                     <span class="errmsgf7a f7a text-info">(Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)</span>
                    </td>
                </tr>
  				<!-- End F7 -->
  				<!-- F8 -->
                ...
                <tr id="f10" >
                    <td class="h">f10</td>
                    <td valign="top" colspan="3">
                        <h5>Apakah anda aktif mencari pekerjaan dalam 4 minggu terakhir?</h5> <h3 style="text-label text-warning"> Pilihlah Satu Jawaban. KEMUDIAN LANJUT KE f17 </h3>
                ...
                <!-- F12 -->
                <tr id="f12" style="display: table-row;">
                    <td class="h">f12</td>
                    <td valign="top" colspan="3">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
