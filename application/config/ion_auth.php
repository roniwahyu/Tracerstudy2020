 ...
 */
$config['site_title']                 = APPSNAME;       // Site Title, example.com
$config['admin_email']                = EMAIL; // Admin Email, admin@example.com
...
$config['email_config'] = [
	...
	'mailtype' => 'html',
	'protocol'    => 'smtp',
    'smtp_crypto' => 'tls', // or html*,
    'smtp_host'    => 'smtp.gmail.com',
    'smtp_port'    => '587',
    'smtp_timeout' => '7',
    'smtp_user'    => 'noreply@widyagama.ac.id',
    // 'smtp_pass'    => '@n3002honh',
    // 'smtp_pass'    => 'riuovcvikgpcquso',
    'smtp_pass'    => 'wjktaxjequlukblj',
    'charset'    => 'utf-8',
    // 'charset'    => 'iso-8859-1',
    'newline'    => "\r\n",
    'crfl'    => "\r\n",
